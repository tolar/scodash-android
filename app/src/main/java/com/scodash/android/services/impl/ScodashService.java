...
public class ScodashService {
    ...
    private Set<RecentsChangeListener> recentsChangeListeners = new HashSet<>();
    ...
    public void addRecentsChangeListener(RecentsChangeListener recentsChangeListener) {
        recentsChangeListeners.add(recentsChangeListener);
    }
    ...
    public void addLoadedDashboard(String hash, Dashboard dashboard) {
        ...
        notifyDashboardListeners(hash);
        notifyRecentsListeners();
    }
    ...
    private void notifyDashboardListeners(String hash) {
    ...
    private void notifyRecentsListeners() {
        for (Iterator<RecentsChangeListener> iterator = recentsChangeListeners.iterator(); iterator.hasNext(); ) {
            RecentsChangeListener recentsChangeListener = iterator.next();
            recentsChangeListener.recentsChanged();
        }
    }

    public Dashboard getLoadedDashboard(int index) {
    ...
    private void connectToServer(String hash) {
        serverWebsocketConnectionService = serverWebsocketServiceProvider.getWsConnection(hash);
    ...
    public void closeConnetionToServer(String hash) {
        serverWebsocketServiceProvider.removeWsConnection(hash);
    }
    ...
    public void clearLoadedDashboards() {
        loadedDashboards.clear();
    }

    public void loadRecentDashboards(SharedPreferences sharedPreferences) {
        //clearLoadedDashboards();
    ...
    public void removeLoadedDashboard(String hash) {
        loadedDashboards.remove(hash);
    }
